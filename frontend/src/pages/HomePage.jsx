        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-in fade-in-50 slide-in-from-bottom-4 duration-1000">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-12 max-w-3xl mx-auto leading-relaxed">
              Experience the future of banking with cutting-edge technology, unmatched security, and personalized financial solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button className="group bg-white text-blue-900 px-8 py-4 rounded-xl font-semibold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-3 cursor-pointer">
                <span>Get Started</span>
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="border-2 border-white/30 !text-white px-8 py-4 rounded-xl font-semibold text-lg backdrop-blur-sm hover:bg-white/10 transition-all duration-300 cursor-pointer">
                Learn More
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We combine innovative technology with traditional banking values to deliver exceptional financial services.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Your money and data are protected by military-grade encryption and advanced fraud detection.',
                color: 'from-blue-500 to-cyan-500'
              },
              {
                icon: Zap,
                title: 'Lightning Fast',
                description: 'Instant transfers, real-time notifications, and lightning-fast mobile app performance.',
                color: 'from-purple-500 to-pink-500'
              },
              {
                icon: Users,
                title: '24/7 Expert Support',
                description: 'Our dedicated team of banking professionals is always here to help you succeed.',
